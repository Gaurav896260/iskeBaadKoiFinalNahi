  ...
  return (
    ...
    <div className="flex flex-col min-h-screen bg-gray-100">
      ...
      <main className="flex-grow flex items-center justify-center px-4 sm:px-6 lg:px-8 ">
        <div className="w-full max-w-md bg-white shadow-md rounded-lg p-8 mt-20 mb-20">
          ...
          <form onSubmit={(e) => e.preventDefault()} className="space-y-6">
            <div>
              <label
                htmlFor="phone"
                className="block text-2xl font-medium font-roboto text-gray-700 mb-1"
              >
                Phone Number
              </label>
              <div className="flex">
                ...
                <input
                  ...
                  className="flex-1 block w-full rounded-r-md border-gray-300 shadow-sm focus:border-gray-500 focus:ring-gray-500 sm:text-sm"
