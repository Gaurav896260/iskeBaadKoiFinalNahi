      ...
      <div className="max-w-4xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
        <div className="bg-white shadow-xl rounded-lg overflow-hidden">
          <div className="px-6 py-8">
            ...
            {!showForm && (
              <button
                className="mt-4 flex items-center justify-center w-full py-2 border border-transparent text-xl font-medium rounded-md text-white bg-gray-800 hover:bg-gray-900 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500"
            ...
            <button
              className="mt-8 w-full py-3 bg-gray-800 text-white font-bold rounded-lg hover:bg-gray-900 transition-all duration-200 disabled:bg-gray-400 disabled:cursor-not-allowed"
              onClick={handleOrder}
